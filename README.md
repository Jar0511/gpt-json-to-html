...
1. ChatGPT 설정에서 대화 내보내기를 선택하여 ZIP 파일을 다운로드합니다.
2. 웹사이트에 접속하여 ZIP 파일을 드래그 앤 드롭하거나 파일 선택 버튼을 클릭합니다.
3. 변환이 완료되면 새로운 ZIP 파일로 다운로드됩니다.
4. 다운받은 ZIP 파일을 압축 해제하고 `index.html`을 브라우저에서 열어보세요.
